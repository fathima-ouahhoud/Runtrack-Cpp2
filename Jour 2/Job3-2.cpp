...
int main() {
    ...
    std::shared_ptr<Pingouin> p1 = std::make_shared<Pingouin>("Pingo", 2.0, 1.5, 5.0);
    std::shared_ptr<Pingouin> p2 = std::make_shared<Pingouin>("Pingu", 2.5, 1.8, 4.5);
    std::shared_ptr<Pingouin> p3 = std::make_shared<Pingouin>("Ping", 3.0, 2.0, 6.0);
